...
class ConfigManager:
    ...
    def get_ssl_context(self):
        ...
        try:
            ...
            cert_path = self.config.cert_path or os.path.join(os.path.dirname(__file__), '..', self.config.network.ssl_cert)
            key_path = self.config.key_path or os.path.join(os.path.dirname(__file__), '..', self.config.network.ssl_key)
